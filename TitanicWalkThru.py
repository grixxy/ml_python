...
print('Logistic Regresson scores: ')

print(cross_val_score(logreg, X, Y, cv=kfold, n_jobs=-1))
...
print('SVC scores with linear kernel: ')

print(cross_val_score(svc, X, Y, cv=kfold, n_jobs=-1))
...
print(cross_val_score(random_forest, X, Y, cv=kfold, n_jobs=-1))
...
# Y_pred = gaussian.predict(X_pred)
